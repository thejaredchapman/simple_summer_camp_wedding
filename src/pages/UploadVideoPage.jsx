    ...
    <div className="upload-page">
      ...
      <div className="upload-card">
        ...
        <p className="upload-share-intro">
          Send us your favorite videos from the weekend — we'd love to see them!
        </p>

        <div className="upload-share-options">
          <a className="upload-share-button" href={`mailto:${SHARE_EMAIL}?subject=${encodeURIComponent('Camp Javery Videos')}`}>
            📧 Email {SHARE_EMAIL}
          </a>
